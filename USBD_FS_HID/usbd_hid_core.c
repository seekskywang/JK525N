...
__ALIGN_BEGIN static uint8_t USBD_HID_Desc[USB_HID_DESC_SIZ] __ALIGN_END=
{
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */  
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[/*HID_MOUSE_REPORT_DESC_SIZE*/HID_REPORT_DESC_SIZE] __ALIGN_END =
{
                                ...
                                USB_SETUP_REQ *req)
{
  ...
  case USB_REQ_TYPE_STANDARD:
    ...
    case USB_REQ_GET_DESCRIPTOR: 
      ...
      {
        len = MIN( HID_REPORT_DESC_SIZE, req->wLength);//HID_MOUSE_REPORT_DESC_SIZE
