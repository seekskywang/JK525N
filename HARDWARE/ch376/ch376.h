...
#define CH376_SPI_CLK                       RCC_APB2Periph_SPI1
#define CH376_SPI_CLK_INIT                  RCC_APB2PeriphClockCmd
...
#define CH376_SPI_SCK_PINSOURCE             GPIO_PinSource5
#define CH376_SPI_SCK_AF                    GPIO_AF_SPI1

#define CH376_SCS_PIN						GPIO_Pin_4
#define CH376_SCS_PORT          			GPIOA
#define CH376_SCS_CLK              			RCC_AHB1Periph_GPIOA
#define CH376_SPI_SCS_PINSOURCE             GPIO_PinSource4
#define CH376_SPI_SCS_AF                    GPIO_AF_SPI1

#define CH376_MOSI_PIN						GPIO_Pin_7
#define CH376_MOSI_PORT          			GPIOA
#define CH376_MOSI_CLK              		RCC_AHB1Periph_GPIOA
#define CH376_SPI_MOSI_PINSOURCE            GPIO_PinSource7
#define CH376_SPI_MOSI_AF                   GPIO_AF_SPI1

#define CH376_MISO_PIN						GPIO_Pin_6
#define CH376_MISO_PORT          			GPIOA
#define CH376_MISO_CLK             		 	RCC_AHB1Periph_GPIOA
#define CH376_SPI_MISO_PINSOURCE            GPIO_PinSource6
#define CH376_SPI_MISO_AF                   GPIO_AF_SPI1

#define SPI_CH376_SCS_LOW()      		    {CH376_SCS_PORT->BSRRH=CH376_SCS_PIN;}
#define SPI_CH376_SCS_HIGH()     			{CH376_SCS_PORT->BSRRL=CH376_SCS_PIN;}
