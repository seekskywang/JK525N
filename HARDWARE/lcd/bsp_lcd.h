...
#define LCD_COLOR_GREY           0x303030
#define LCD_COLOR_BLUE2           0x0000FF
#define LCD_COLOR_BLUE          0x000028
...
#define	LCD_COLOR_SELECT      LCD_COLOR_RED  //被选中的颜色
...
void LCD_DispString_EN_CH( uint16_t x , uint16_t y, const uint8_t * ptr );
...
void LCD_DisplayChar24(uint16_t Line, uint16_t Column, uint8_t Ascii);
